...
namespace ECommerce.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        /// <summary>
        /// Gets Product from db and return in a view
        /// </summary>
        /// <returns>Returns Product List Views</returns>
        [Route("index", Name = "ListProduct")]
        ...
        [HttpGet]
        [Route("productadd", Name = "AddProduct")]
        public ActionResult ProductAdd()
        {
            AddProductViewModel viewModel = new AddProductViewModel();
            viewModel.Categorylist = context.Subcategories.Where(x=>x.isdeleted==false).Select(x => new SelectListItem()
            {
                Value = x.id.ToString(),
                Text = x.name
            }).ToList();

            viewModel.Brandlist = context.Brands.Where(x => x.isdeleted == false).Select(x => new SelectListItem()
            {
                Value = x.id.ToString(),
                Text = x.name
            }).ToList();
        ...
        /// 
        /// </summary>
        /// <param name="model">Product Detail that gonna save to db</param>
        /// <returns></returns>
        [HttpPost]
        [ValidateAntiForgeryToken]
        [Route("productadd",Name ="AddProductPost")]
        public ActionResult ProductAdd(AddProductViewModel model)
        {
            ...
            model.Categorylist = context.Subcategories.Select(x => new SelectListItem()
            {
                Value = x.id.ToString(),
                Text = x.name
            }).ToList();

            model.Brandlist = context.Brands.Select(x => new SelectListItem()
            {
                Value = x.id.ToString(),
                Text = x.name
            }).ToList();
        ...
        [Route("productdelete", Name = "DeleteProduct")]
        ...
        [HttpGet]
        [Route("productedit", Name = "EditProduct")]
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        [Route("productedit", Name = "EditProductPost")]
